...
const Cart = () => {
            ...
            <div className="flex items-center md:gap-6 gap-3">
              ...
              <div>
                ...
                {/* <div className="font-normal text-gray-500/70">
                  ...
                  <p>
  Weight: <span>{product.weight ? product.weight * product.quantity : "N/A"}</span>
</p> */}
  ...
  {/* <p>
    ...
    <span>
      {product.weight
        ? product.weight * (cartItems?.[product._id] || 1)
        : "N/A"}
    </span>
  </p> */}
<p>
  ...
  <span>
    {product.weight
      ? parseFloat(product.weight) * (cartItems?.[product._id] || 1)
      : "N/A"}{" "}
    {typeof product.weight === "string"
      ? product.weight.replace(/[0-9.]/g, "").trim()
      : ""}
  </span>
</p>
  ...
  <div className="flex items-center">
    ...
    >
      ...
      <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
        ...
        <div className="bg-yellow-50 border border-yellow-300 text-yellow-700 p-3 rounded-md mt-4 text-sm">
  🛍️ Shop for <span className="font-semibold">₹500 or more</span> to get 
  ...
  <p className="flex justify-between">
    <span>Price</span>
      <span>₹{Math.round(totalCartAmount())}</span>
  ...
  {totalCartAmount() <= 500 && (
    <p className="text-sm text-indigo-500 mt-1">
      💡 Buy items worth ₹{(500 - totalCartAmount()).toFixed(2)} more to get{" "}
