      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        {user ? (
          <div className="relative group flex items-center gap-2 cursor-pointer">
            ...
            <ul className="hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 py-2 w-40 rounded-md z-40 text-sm">
              <li
      ...
      >
        ...
        {user ? (
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium">{user.name}</span>
            <button
              className="ml-2 px-4 py-1 text-sm bg-red-500 text-white rounded-full"
              onClick={logout}
            >
              Logout
            </button>
