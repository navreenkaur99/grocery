...
const Footer = () => {
  return (
    <footer className="text-gray-600 pt-10 px-6 md:px-16 lg:px-24 xl:px-32 bg-gray-50">
      <div className="flex flex-wrap justify-between gap-10 md:gap-6">
        
        {/* --- Brand Info --- */}
        <div className="max-w-80">
          <h1 className="text-3xl font-semibold text-[#212121]">GroceryApp</h1>
          <p className="text-sm mt-2">
            © {new Date().getFullYear()} GroceryApp. Developed as part of MCA Project by Navreen Kaur.
            <br />
            Smart, simple, and efficient grocery shopping experience.
          </p>
          ...
          <div className="flex items-center gap-3 mt-4 text-gray-700">
            ...
            <a href="https://www.instagram.com/" target="_blank" rel="noopener noreferrer">
              <svg className="w-6 h-6 hover:text-black" fill="currentColor" viewBox="0 0 24 24">
        ...
        {/* --- Locations --- */}
        <div>
          <p className="text-lg text-gray-800 font-medium">LOCATIONS</p>
          <ul className="mt-3 flex flex-col gap-2 text-sm">
            <li>Amritsar</li>
            <li>Jalandhar</li>
            <li>Ludhiana</li>
        ...
        {/* --- Contact Info --- */}
        <div>
          <p className="text-lg text-gray-800 font-medium">CONTACT</p>
          <ul className="mt-3 flex flex-col gap-2 text-sm">
      ...
      <div className="flex flex-col md:flex-row gap-2 items-center justify-between py-5 text-sm">
        <p>© {new Date().getFullYear()} GroceryApp. All rights reserved.</p>
...
//           <p className="text-sm">
//             © 2025 GroceryApp. Developed as part of MCA Project by Navreen Kaur.
// Smart, simple, and efficient grocery shopping experience.
//           </p>
